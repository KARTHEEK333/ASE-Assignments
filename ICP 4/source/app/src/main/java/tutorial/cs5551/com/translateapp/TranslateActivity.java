...
public class TranslateActivity extends AppCompatActivity {
    ...
    public void translateText(View v) {
        ...
        String text =spin.getSelectedItem().toString();// contains code of language and its defination
        StringTokenizer l = new StringTokenizer(text,":");
        String text1 =l.nextToken(":");//gives code of language eg: af, az etc
        ...
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang=en-"+text1+"&[format=plain]&[options=1]&[callback=set]";//The API service URL
